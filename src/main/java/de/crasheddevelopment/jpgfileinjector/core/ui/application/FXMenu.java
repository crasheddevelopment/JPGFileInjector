...
public class FXMenu extends Application
{
    ...
    private final Parent root = FXMLLoader.load(getClass().getResource(ThemeUtils.USED_THEMES));
    private final Scene scene = new Scene(root, 868, 510);

    // Public method.
    public FXMenu () throws IOException
    {}

    // Close handle window event.
    ...
    {
        // Close event.
        stage.setOnCloseRequest(FXMenu::handle);
