...
public class JFrameUpdate extends JFrame
{
    ...
    public void initJFrame ()
    {
        ...
        int inputValue = JOptionPane.showConfirmDialog(null, "The injector got a new update.\nDo you want to download it?");

        // Checks the inputValue.
        if (inputValue == 0)
        {
            StringUtils.sendInformation("Downloading update...");
            new Updater().downloadUpdate();
        }
    }
}