...
package de.crasheddevelopment.jpgfileinjector.core.converter;

public class HEXToBytes
{
    // Method to convert HEX into bytes.
    public final byte[] convertHEXToBytes (String hexString)
    {
        ...
        {
            bytes[x / 2] = (byte) ((Character.digit(hexString.charAt(x), 16) << 4) + Character.digit(hexString.charAt(x + 1), 16));
        }
