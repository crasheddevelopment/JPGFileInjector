...
import de.crasheddevelopment.jpgfileinjector.core.themes.ThemeSettings;
...
public class JPGFileInjector
{
    ...
    private static final ThemeSettings themeSettings = new ThemeSettings();
    ...
    public static void main (String[] args)
    {
        ...
        if (Files.exists(fileManager.themeSettingPath))
        {
            // Load theme file settings.
            themeSettings.checkSettings();
            Booleans.THEME_CONFIG_AVAILABLE = true;
        }
        else
        {
            // Create the theme file.
            themeSettings.createThemeFile();
        }
        ...
        if (!Booleans.UPDATE_AVAILABLE)
        {
            ...
            // Sends output.
            StringUtils.sendInformation("No available updates found!");
            System.out.println(" ");
